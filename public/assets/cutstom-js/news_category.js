function delete_category(id){
    var popup = jQuery('#modal-delete-news-category')
        ...
        success: function (record) {
            ...
            $('#body-category').html(`
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="keywords" value="${record.keywords}" class="form-control" autofocus/>
                        </div>
                        <div class="form-group">
            ...
            $("#modal-update-news-category").modal("show");
        }
    });
}
